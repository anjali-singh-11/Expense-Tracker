  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 w-full max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
         type="submit"
         className="w-full bg-expense-light text-white py-2 rounded-md hover:bg-expense-dark font-medium focus:outline-none focus:ring-2 focus:ring-expense-light transition-all"
         disabled={isSubmitting}
         >
